...
RCT_EXPORT_VIEW_PROPERTY(blockedUrls, NSArray);
RCT_EXPORT_VIEW_PROPERTY(blockedUrlsDuration, NSInteger)
RCT_EXPORT_VIEW_PROPERTY(unblockedUrlsDuration, NSInteger)
