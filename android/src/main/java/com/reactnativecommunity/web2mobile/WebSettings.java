...
public class WebSettings {
  ...
  public void setForceDarkOn(boolean forceDarkOn) {
    ...
    if (webkitSettings != null) {
      ...
      if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
        ...
        // PREFER_WEB_THEME_OVER_USER_AGENT_DARKENING:  checks for the "colorscheme" <meta> tag.
        // If present, it uses media queries. If absent, it applies useragent (automatic)
  ...
  public void setMinimumFontSize(int minimumFontSize) {
    ...
    if (webkitSettings != null) {
      webkitSettings.setMinimumFontSize(minimumFontSize);
    }
  }
